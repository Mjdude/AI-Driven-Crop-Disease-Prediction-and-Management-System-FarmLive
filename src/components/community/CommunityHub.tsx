  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="feed" className="space-y-6">
        ...
        <TabsContent value="feed" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              >
                <p className="text-gray-500">What's on your mind? Share your farming journey...</p>
              </div>
              <div className="flex justify-between items-center">
                <div className="flex gap-2">
          ...
          <div className="space-y-4">
            {filteredPosts.map((post) => (
              <Card
                key={post.id}
                className={`transition-all hover:shadow-lg cursor-pointer ${!post.read ? 'border-l-4 border-l-blue-500 bg-blue-50/30' : ''}`}
        ...
        <TabsContent value="stories" className="space-y-6">
          <div className="flex justify-between items-center">
            ...
            <Button onClick={() => setShowShareStory(true)}>
              ...
              <Card key={mentor.id} className="hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" onClick={() => handleViewMentor(mentor)}>
                      View Profile
                    </Button>
                  </div>
                </CardContent>
      ...
      <PostDetailsDialog
        ...
        onOpenChange={setShowPostDetails}
        post={selectedPost}
        onLike={handleLike}
      />
      ...
      <ShareStoryDialog
        open={showShareStory}
        onOpenChange={setShowShareStory}
        onSuccess={(story) => setStories([story, ...stories])}
      />

      <CreateEventDialog
        open={showCreateEvent}
        onOpenChange={setShowCreateEvent}
        onSuccess={(event) => setEvents([...events, event])}
      />
