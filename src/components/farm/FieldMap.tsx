...
import { MapPin, Droplet, Calendar, X } from 'lucide-react';
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 flex flex-col lg:flex-row gap-6 min-h-[500px]">
                {/* Map Area */}
                <div className="flex-1 rounded-xl overflow-hidden border-2 border-green-100 relative z-0 min-h-[500px]">
                    <MapContainer key={selectedField ? 'selected' : 'default'} center={[28.6139, 77.2090]} zoom={15} style={{ height: '500px', width: '100%' }}>
                        <TileLayer
