...
export const RecentActivities: React.FC = () => {
  ...
  const activities = [
    {
      action: t('activities.wheat_harvest'),
      field: 'Field A',
      time: '2 hours ago',
      icon: Leaf,
    ...
    {
      action: t('activities.irrigation_activated'),
      field: 'Corn field B',
      time: '4 hours ago',
      icon: Droplets,
      color: 'text-blue-500'
    ...
    {
      action: t('activities.pest_photos_uploaded'),
    ...
    {
      action: t('activities.fertilizer_scheduled'),
      field: 'Onion field C',
      time: '8 hours ago',
      icon: Settings,
    ...
    {
      action: t('activities.sensor_calibrated'),
      field: 'Field A',
      time: '1 day ago',
      icon: Settings,
      color: 'text-gray-500'
